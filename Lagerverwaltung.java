...
public class Lagerverwaltung {
	...
	static void eingabe(int[][]argEingabe) {
		...
		do {
			...
			//Nur wenn die beiden bedingungen in der 1. if anweisung wahr sind wird die 2. if anweisung ausgeführt
			if (kistenNummer > 0 && kistenNummer<=argEingabe.length)
				if (argEingabe[kistenNummer-1][0]==0) {
					...
					System.out.println("Die Kistennummer ist schon vorhanden.");
				}
		}
	...
	static void  anzeigen(int [][] argAnzeigen) {
		...
		//Die If anweisug wird ausgeführt nur wenn alle bedingungen wahr sind
	...
	static void liste(int [][] argListe) {
		int counter = 0;
		//Die for schleife geht jedes array durch und gibt nur die Arrazs die ungleich 0 sind
	...
	static void löschen(int [][] argLöschen) {
	     ...
	     //Wenn Kistennummer ungleich 0 ist wird die i anweisung ausgeführt und die die Werte der Kiste auf 0 gesetzt
